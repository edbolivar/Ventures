  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <div className={classes.contentWrapper}>
          <div className={classes.innerContentWrapper}>
            <div id="slideOne" className={classNames(classes.slide)}>
              <div className={classes.headline}>Something Catchy <span className={classes.redEmphasis}>&</span> Something Catchy</div>
              <div className={classes.subHeadline}>
                Mauris neque lectus, ullamcorper nec nisl eget, interdum facilisis lacus. Praesent eros diam, tempor ut sem et, pellentesque tincidunt diam.
              </div>

              <div className={classes.searchTypeBtnsWrapper}>
                <button className={classes.searchTypeBtn}>Search Residential</button>
                <button className={classes.searchTypeBtn}>Search Commercial</button>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <ArrowIcon classes={{ root: classes.downArrowIcon }} color="inherit" />
        </Link>
      </div>
    );
  }
